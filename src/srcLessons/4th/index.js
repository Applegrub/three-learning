...
function main() {
  ...
  const planeGe0 = new THREE.PlaneGeometry(planeSize, planeSize)
  const planeMat = new THREE.MeshStandardMaterial({map: texture, side: THREE.DoubleSide})
  const mesh = new THREE.Mesh(planeGe0, planeMat)
...

  {
    ...
    const sphereMat = new THREE.MeshStandardMaterial({color: '#8AC'})
